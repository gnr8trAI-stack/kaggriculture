"""V34.8 isolated herd-funded third-land experiment.

Single economic mechanism on top of V34.6: once the two-land dairy estate is
actually saturated (>=10 active cows and >=10 pastures), reinvest surplus cash
into exactly one third land purchase while there is still enough runway to
...
Rationale: prior raw land experiments failed because extra acreage was bought
before productive demand existed. V34.5/V34.6 proved livestock demand can reach
~10-12 active cows. This candidate tests the economically coupled case: buy the
third quadrant only after the livestock estate is demonstrably capacity-bound.
No fourth-land logic is added.
"""
