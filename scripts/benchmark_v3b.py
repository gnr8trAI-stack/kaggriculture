"""Benchmark conservative Agent V3b against frozen Agent V2."""
...
from agents.v3b_conservative import agent as candidate_agent
...
def run_benchmark(games_per_seat: int, output: Path | None = None):
    ...
    for seat in (0, 1):
        for seed in range(games_per_seat):
            ...
            print(
                f"seed={seed:04d} seat={seat} v3b={result.candidate_reward:.0f} "
    ...
    payload = {
        "candidate": "agents.v3b_conservative",
