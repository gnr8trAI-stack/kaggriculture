"""Benchmark Agent V5 task routing against frozen Agent V2."""
...
from agents.v5_task_routing import agent as candidate_agent
...
def run_benchmark(games_per_seat: int, output: Path | None = None):
    ...
    for seat in (0, 1):
        for seed in range(games_per_seat):
            ...
            print(
                f"seed={seed:04d} seat={seat} v5={result.candidate_reward:.0f} "
    ...
    payload = {
        "candidate": "agents.v5_task_routing",
