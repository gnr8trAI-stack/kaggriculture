"""Benchmark V13 against repository opponents."""
import argparse
import sys
...
from agents import v13_hybrid_champion as candidate
from agents import v12_agent, v11_agent
...
def run_benchmark(games_per_seat=10, seed_start=90000, output=None, telemetry_output=None):
    ...
    try:
        ...
        payload["candidate"] = "agents.v13_hybrid_champion"
